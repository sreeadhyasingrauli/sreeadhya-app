                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($customer->address_to); ?></td>
                            <td><?php echo e($customer->customer_name); ?></td>
                            <td><?php echo e($customer->customer_short_name); ?></td>
                            ...
                            <td><?php echo e($customer->pin_code); ?></td>
                            <td><?php echo e($customer->country); ?></td>
                            <td><?php echo e($customer->contact_number); ?></td>
                            <td><?php echo e($customer->email); ?></td>
                            <td><?php echo e($customer->website); ?></td>
                            <td><?php echo e($customer->pan_number); ?></td>
                            <td><?php echo e($customer->gst_number); ?></td>

                            <td>
                                <form action="<?php echo e(route('customers.destroy', $customer->customer_id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>

                                    <a href="<?php echo e(route('customers.show', $customer->customer_id)); ?>" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>

                                    <a href="<?php echo e(route('customers.edit', $customer->customer_id)); ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
...
<?php echo $__env->make('customers.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pksso\sreeadhya\resources\views\customers\index.blade.php ENDPATH**/ ?>