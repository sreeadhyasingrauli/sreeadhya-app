    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <a href="<?php echo e(route('budgetories.index')); ?>" class="btn btn-primary btn-sm">&larr; Back</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->budgetory_number); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->budgetory_date); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->customer_name); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->address_to); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->budget_description); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->budget_amount); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->payment_terms); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->delivery_terms); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->warranty_terms); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->offer_validity); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="line-height: 35px;">
                            <?php echo e($budgetory->validity_end_date); ?>
...
<?php echo $__env->make('budgetories.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pksso\sreeadhya\resources\views\budgetories\show.blade.php ENDPATH**/ ?>