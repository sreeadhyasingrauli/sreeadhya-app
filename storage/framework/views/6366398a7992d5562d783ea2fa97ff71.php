    ...
    <div class="max-w-4xl mx-auto bg-white p-8 border border-gray-200 rounded-lg shadow-sm print:border-0 print:shadow-none">
        ...
        <div class="grid grid-cols-2 gap-4 border-b border-gray-200 pb-8">
            ...
            <div class="text-right">
                ...
                <p class="text-xl font-mono font-bold text-blue-600"><?php echo e($po->po_number); ?></p>
                <p class="text-sm font-semibold text-gray-700 mt-2">Date</p>
                <p class="text-sm text-gray-600"><?php echo e($po->created_at->format('M d, Y')); ?></p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 my-8">
            <div>
                ...
                <p class="font-semibold text-gray-800"><?php echo e($po->vendor->name); ?></p>
                <p class="text-sm text-gray-600"><?php echo e($po->vendor->address); ?></p>
                <p class="text-sm text-gray-600"><?php echo e($po->vendor->email); ?></p>
            </div>
            <div>
                    ...
                    <?php $__currentLoopData = $po->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="py-4 px-4 font-medium text-gray-900">
                                ...
                                <?php if($item->sku): ?>
                                    <span class="block text-xs text-gray-400 mt-0.5">SKU: <?php echo e($item->sku); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="py-4 px-4 text-right font-mono"><?php echo e($item->quantity); ?></td>
                            <td class="py-4 px-4 text-right font-mono">$<?php echo e(number_format($item->price, 2)); ?></td>
                            <td class="py-4 px-4 text-right font-mono">$<?php echo e(number_format($item->quantity * $item->price, 2)); ?></td>
                        </tr>
        ...
        <div class="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-gray-200">
            <div>
                ...
                <p class="text-xs text-gray-500 leading-relaxed"><?php echo e($po->notes ?? 'Payment terms: Net 30 days. Please send confirmation upon receipt.'); ?></p>
            </div>
            <div class="flex flex-col items-end justify-start space-y-2 text-sm">
                <div class="flex justify-between w-64 border-b border-gray-100 pb-2">
                    ...
                    <span class="font-mono text-gray-800">$<?php echo e(number_format($po->subtotal, 2)); ?></span>
                </div>
                <div class="flex justify-between w-64 border-b border-gray-100 pb-2">
                    <span class="text-gray-500">Tax (<?php echo e($po->tax_rate); ?>%):</span>
                    <span class="font-mono text-gray-800">$<?php echo e(number_format($po->tax_amount, 2)); ?></span>
                </div>
                <div class="flex justify-between w-64 text-base font-bold pt-2">
                    <span class="text-gray-900">Total:</span>
                    <span class="font-mono text-blue-600">$<?php echo e(number_format($po->total_amount, 2)); ?></span>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\pksso\sreeadhya\resources\views\purchase-order.blade.php ENDPATH**/ ?>