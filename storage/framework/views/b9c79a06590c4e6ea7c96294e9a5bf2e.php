...
unset($__errorArgs, $__bag); ?>" id="part_number" name="part_number" value="<?php echo e(old('part_number')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="part_description" name="part_description" value="<?php echo e(old('part_description')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="uom" name="uom" value="<?php echo e(old('uom')); ?>">
                            <?php $__errorArgs = ['uom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="hsn_code" name="hsn_code" value="<?php echo e(old('hsn_code')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="gst_rate" name="gst_rate" value="<?php echo e(old('gst_rate')); ?>">
...
<?php echo $__env->make('parts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pksso\sreeadhya\resources\views\parts\create.blade.php ENDPATH**/ ?>