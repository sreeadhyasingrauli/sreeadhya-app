...
<body class="bg-gray-50 font-sans antialiased text-gray-900 critical-path">
    ...
    <div class="max-w-4xl mx-auto my-8 p-8 bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="flex justify-end gap-3 mb-6 no-print">
            ...
            <a href="<?php echo e(route('purchase-orders.index')); ?>" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded border transition">
                Back to List
            </a>
        </div>
        ...
        <div class="flex justify-between items-start border-b border-gray-200 pb-6 mb-6">
            <div>
                ...
                <div class="text-2xl font-bold tracking-tight text-gray-900 uppercase">
                    <?php echo e(config('app.name', 'Your Company')); ?>
            ...
            <div class="text-right">
                ...
                <dl class="grid grid-cols-2 gap-x-2 gap-y-1 text-sm mt-4">
                    ...
                    <dd class="text-gray-900 font-mono"><?php echo e($purchaseOrder->po_number); ?></dd>
                    
                    <dt class="font-semibold text-gray-600 text-left">PO Date:</dt>
                    <dd class="text-gray-900"><?php echo e($purchaseOrder->created_at->format('Y-m-d')); ?></dd>
                    
                    <dt class="font-semibold text-gray-600 text-left">Delivery Due:</dt>
                    <dd class="text-gray-900 font-medium text-red-600"><?php echo e($purchaseOrder->delivery_due_date->format('Y-m-d')); ?></dd>
        ...
        <div class="grid grid-cols-2 gap-8 mb-8">
            <div>
                ...
                <div class="text-sm">
                    <p class="font-bold text-gray-900 text-base"><?php echo e($purchaseOrder->vendor->name); ?></p>
                    <p class="text-gray-600 mt-1"><?php echo e($purchaseOrder->vendor->address); ?></p>
                    <p class="text-gray-600"><?php echo e($purchaseOrder->vendor->city); ?>, <?php echo e($purchaseOrder->vendor->state); ?> <?php echo e($purchaseOrder->vendor->zip); ?></p>
                    <p class="text-gray-600 mt-2">Contact: <?php echo e($purchaseOrder->vendor->contact_name); ?></p>
                    <p class="text-gray-600">Email: <?php echo e($purchaseOrder->vendor->email); ?></p>
                </div>
            </div>
            <div>
                <h2 class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Ship To / Delivery Address</h2>
                <div class="text-sm">
                    <p class="font-bold text-gray-900 text-base"><?php echo e($purchaseOrder->shipping_address_name ?? config('app.name')); ?></p>
                    <p class="text-gray-600 mt-1"><?php echo e($purchaseOrder->shipping_address); ?></p>
                    <p class="text-gray-600"><?php echo e($purchaseOrder->shipping_city); ?>, <?php echo e($purchaseOrder->shipping_state); ?> <?php echo e($purchaseOrder->shipping_zip); ?></p>
                    <p class="text-gray-600 mt-2">Shipping Method: <?php echo e($purchaseOrder->shipping_method ?? 'Standard Ground'); ?></p>
                    <p class="text-gray-600">Payment Terms: <?php echo e($purchaseOrder->payment_terms ?? 'Net 30'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="border border-gray-200 rounded-lg overflow-hidden mb-6">
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $purchaseOrder->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="px-4 py-3 text-center text-gray-400 font-mono"><?php echo e($index + 1); ?></td>
                            <td class="px-4 py-3">
                                <div class="font-medium text-gray-900"><?php echo e($item->name); ?></div>
                                <?php if($item->sku): ?>
                                    <div class="text-xs text-gray-400 mt-0.5">SKU: <?php echo e($item->sku); ?></div>
                                <?php endif; ?>
                            </td>
                            <td class="px-4 py-3 text-right font-mono"><?php echo e(number_format($item->quantity)); ?></td>
                            <td class="px-4 py-3 text-right font-mono">$<?php echo e(number_format($item->unit_price, 2)); ?></td>
                            <td class="px-4 py-3 text-right font-mono font-medium">$<?php echo e(number_format($item->total_price, 2)); ?></td>
                        </tr>
            ...
            <div class="col-span-5 border border-gray-100 rounded-lg p-4 bg-gray-50/50">
                <dl class="space-y-2 text-sm">
                    <div class="flex justify-between text-gray-600">
                        <dt>Subtotal:</dt>
                        <dd class="font-mono">$<?php echo e(number_format($purchaseOrder->subtotal, 2)); ?></dd>
                    </div>
                    <?php if($purchaseOrder->tax_amount > 0): ?>
                        <div class="flex justify-between text-gray-600">
                            <dt>Tax (<?php echo e($purchaseOrder->tax_rate); ?>%):</dt>
                            <dd class="font-mono">$<?php echo e(number_format($purchaseOrder->tax_amount, 2)); ?></dd>
                        </div>
                    <?php endif; ?>
                    <?php if($purchaseOrder->shipping_cost > 0): ?>
                        <div class="flex justify-between text-gray-600">
                            <dt>Shipping & Handling:</dt>
                            <dd class="font-mono">$<?php echo e(number_format($purchaseOrder->shipping_cost, 2)); ?></dd>
                        </div>
                    <?php endif; ?>
                    <div class="flex justify-between text-base font-bold text-gray-900 border-t border-gray-200 pt-2 mt-2">
                        ...
                        <dd class="font-mono">$<?php echo e(number_format($purchaseOrder->total, 2)); ?></dd>
                    </div>
                </dl>
            </div>
        </div>
...
<?php /**PATH C:\Users\pksso\sreeadhya\resources\views\purchase-orders\show.blade.php ENDPATH**/ ?>