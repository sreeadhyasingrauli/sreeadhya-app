            ...
            <div class="card-body">
                <form action="<?php echo e(route('customers.store')); ?>" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control <?php $__errorArgs = ['address_to'];
...
unset($__errorArgs, $__bag); ?>" id="address_to" name="address_to" value="<?php echo e(old('address_to')); ?>">
                            <?php $__errorArgs = ['address_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="customer_name" name="customer_name" value="<?php echo e(old('customer_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control <?php $__errorArgs = ['customer_short_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="customer_short_name" name="customer_short_name" value="<?php echo e(old('customer_short_name')); ?>">
                            <?php $__errorArgs = ['customer_short_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="address_line1" name="address_line1" value="<?php echo e(old('address_line1')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="address_line2" name="address_line2" value="<?php echo e(old('address_line2')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="state" name="state" value="<?php echo e(old('state')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="pin_code" name="pin_code" value="<?php echo e(old('pin_code')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="country" name="country" value="<?php echo e(old('country')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="contact_number" name="contact_number" value="<?php echo e(old('contact_number')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="website" name="website" value="<?php echo e(old('website')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="pan_number" name="pan_number" value="<?php echo e(old('pan_number')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="gst_number" name="gst_number" value="<?php echo e(old('gst_number')); ?>">
...
<?php echo $__env->make('customers.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pksso\sreeadhya\resources\views\customers\create.blade.php ENDPATH**/ ?>