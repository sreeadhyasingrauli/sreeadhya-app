...
unset($__sessionArgs); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('invoices.create')); ?>" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i> Add New Invoice</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('invoices.destroy', $inv->id)); ?>" method="post">
                                    ...
                                    <a href="<?php echo e(route('invoices.pdf', $inv->id)); ?>" class="btn btn-primary btn-sm"> Download</a>
                                    <a href="<?php echo e(route('invoices.show', $inv->id)); ?>" class="btn btn-primary btn-sm"> Payment Received</a>
...
<?php echo $__env->make('invoices.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pksso\sreeadhya\resources\views\invoices\index.blade.php ENDPATH**/ ?>