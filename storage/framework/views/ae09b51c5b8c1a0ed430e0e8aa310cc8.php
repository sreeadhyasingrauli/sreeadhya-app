    ...
    <div class="invoice-box">
        <div class="header">
            ...
            <div style="text-align: right;">
                ...
                <p><strong>Date :</strong> <?php echo e($invoice->invoice_date); ?></p>
            </div>
        </div>

        <div style="margin-top: 30px;">
            <h4>Invoiced To:</h4>
            <p><strong>Name:</strong> <?php echo e($invoice->customer_name); ?></p>
            <p><strong>Email:</strong> <?php echo e($invoice->customer_email); ?></p>
            <p><strong>Address:</strong> <?php echo e($invoice->customer_address); ?></p>
        </div>
        ...
        <div class="total">
            Total Amount Due: $<?php echo e(number_format($invoice->amount, 2)); ?>

        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\pksso\sreeadhya\resources\views\pdf\pdf_template.blade.php ENDPATH**/ ?>