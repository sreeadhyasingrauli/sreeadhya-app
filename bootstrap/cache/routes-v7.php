...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::EUBnQmhBAYB749c5',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'dashboard.purchase-orders',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/p(?|arts/([^/]++)(?|(*:28)|/edit(*:40)|(*:47))|roducts/([^/]++)(?|(*:74)|/edit(*:86)|(*:93))|urchase\\-orders/(?|([^/]++)(?|(*:131)|/edit(*:144)|(*:152))|accept/([^/]++)(*:176)))|/c(?|ompanies/([^/]++)(?|(*:211)|/edit(*:224)|(*:232))|ustomers/([^/]++)(?|(*:261)|/edit(*:274)|(*:282)))|/offer(?|s/(?|([^/]++)(?|(*:317)|/edit(*:330)|(*:338))|download/([^/]++)(*:364))|/([^/]++)(*:382))|/quotes/([^/]++)(?|(*:410)|/edit(*:423)|(*:431))|/invoice(?|s/([^/]++)(?|(*:464)|/(?|edit(*:480)|p(?|df(*:494)|ayments(*:509)))|(*:519))|/([^/]++)/preview(*:545))|/storage/(.*)(?|(*:570)))/?$}sDu',
    ),
    3 => 
    array (
      28 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'purchase-orders.order-acceptance',
          ),
          1 => 
          array (
            0 => 'id',
  ...
  array (
    ...
    array (
      ...
      'action' => 
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:1130:"function (\\Illuminate\\Http\\Request $request) {
                    $exception = null;
                    ...
                    return response(\\Illuminate\\Support\\Facades\\View::file(\'C:\\\\Users\\\\pksso\\\\sreeadhya\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Foundation\\\\Configuration\'.\'/../resources/health-up.blade.php\', [
                        \'exception\' => $exception,
                    ]), status: $status);
                }";s:5:"scope";s:54:"Illuminate\\Foundation\\Configuration\\ApplicationBuilder";s:4:"this";N;s:4:"self";s:32:"00000000000008cd0000000000000000";}}',
        'as' => 'generated::EUBnQmhBAYB749c5',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\PurchaseOrderController@generateOrderAcceptance',
        'controller' => 'App\\Http\\Controllers\\PurchaseOrderController@generateOrderAcceptance',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'purchase-orders.order-acceptance',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\OfferController@download',
        'controller' => 'App\\Http\\Controllers\\OfferController@download',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
