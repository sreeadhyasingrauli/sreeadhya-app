<aside class="w-64 bg-slate-900 text-gray-100 flex flex-col h-full border-r border-slate-800">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        <a href="{{ route('dashboard.vendors') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-800 text-black-300 transition-colors">
            <span>👥</span> Vendors
        </a>
        ...
        <a href="{{ route('dashboard.inventory') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-800 text-black-300 transition-colors">
            <span>📄</span> Inventory
        </a>
