<header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-10">
    ...
    <div class="flex items-center gap-6">
        ...
        <!-- Quick Create Button -->
        <a href="{{ route('dashboard.invoices') }}" class="flex items-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors">
