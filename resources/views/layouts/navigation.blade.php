<header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-10 shadow-sm">
    ...
    <div class="flex items-center gap-4">
        <!-- Action Button -->
        <a href="{{ route('invoices.create') }}" class="hidden sm:flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs px-3 py-2 rounded-lg font-medium shadow-sm transition-all">
