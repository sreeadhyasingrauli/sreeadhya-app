...
<body>
    ...
    <table class="info-table">
            ...
            <td style="text-align: left;">
                ...
                @foreach($customerWithChallan as $customer)
            ...
            <td style="text-align: right;">
                <strong>Challan Number:</strong> {{ $challan->challan_number }}<br>
                <strong>Challan Date:</strong> {{ \Illuminate\Support\Carbon::parse($challan->challan_date)->format('d-m-Y') }}<br>
                 
                
                 <strong>PO Number:</strong> {{  $challan->order_number }}<br>
                 <strong>PO Date:</strong> {{ \Illuminate\Support\Carbon::parse($challan->order_date)->format('d-m-Y') }}<br>
