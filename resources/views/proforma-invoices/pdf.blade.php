...
<body>
    ...
    <div class="header"> 
            ...
            <strong>Email ID : </strong> {{ $company ->email }} <br>
            <strong>Website : </strong> {{ $company ->website }}, <strong>GST Number:</strong> {{ $company->gst_number }} <br>
            @endforeach
            </div>   
    ...
    <table class="info-table">
            ...
            <td style="text-align: right;">
                <strong>Proforma Invoice Number:</strong> {{ $proformaInvoices->invoice_number }}<br>
                <strong>Proforma Invoice Date:</strong> {{ \Illuminate\Support\Carbon::parse($proformaInvoices->invoice_date)->format('d-m-Y') }}<br>
        ...
        <tbody>
            @foreach($proformaInvoices->items as $item)
            <tr>
    ...
    <table class="info-table">
            ...
            <td style="text-align: right;">
                <strong>Sub-Total :</strong> {{ $proformaInvoices->basic_amount }}<br>
                <p><strong>GST Amount @</strong> {{ $item->gst_rate }}% : {{ $proformaInvoices->gst_amount }}</p>
                <strong>Proforma Invoice Amount :</strong> {{ $proformaInvoices->invoice_amount }}
            </td>
        </tr>
        </table>
            <div class="header">
