...
<body>
            ...
            <td style="text-align: left;">
             ...
             @endforeach
               ...
               <strong>Order Number:</strong> {{ $order->order_number }}<br>
                <strong>Order Date:</strong> {{ \Illuminate\Support\Carbon::parse($order->order_date)->format('d-m-Y') }}<br>
    ...
    <table class="info-table">
            ...
            <td style="text-align: right;">
                <strong>Basic Value :</strong> {{ $order->sub_total }}<br>
                <p><strong>GST Value:</strong> {{ $order->gst_amount }}</p>
