    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('orders.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="order_number" class="col-md-4 col-form-label text-md-end text-start">Order Number</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('order_number') is-invalid @enderror" id="order_number" name="order_number" value="{{ old('order_number') }}">
                            @error('order_number')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <select class="form-control @error('payment_terms') is-invalid @enderror" id="payment_terms" name="payment_terms">
                                ...
                                <option value="100% within 30 days of receipt and acceptance of materials at site" {{ old('payment_terms') == '2' ? 'selected' : '' }}>100% within 30 days of receipt and acceptance of materials at site</option>
                                <option value="Accepted as per your NIT/Offer" {{ old('payment_terms') == '3' ? 'selected' : '' }}>Accepted as per your NIT/Offer</option>
                            </select>
                            @error('payment_terms')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
        ...
        <select name="items[0][product_id]" class="form-control" required>
            ...
            @foreach ($allProducts as $product)
                <option value="{{ $product->product_id }}">{{ $product->product_id }}-{{ $product->part_number }}</option>
            @endforeach
        </select>
        ...
        <div class="mb-0">
            ...
            <input type="number" name="items[0][order_quantity]" class="form-control" min="1" placeholder="Qty" required>
        </div>
